...
$\ActionSpace_l$ : the action space of a learning agent $l$, typically $\mathbb{A}_l \subseteq \mathbb{R}^d$.

$d$ : number of dimensions of the agent's action space.

$\mathbf{a}$ : an action in the action space, i.e., a vector of $d$ dimensions.

$\ObsSpace_l$ : the observation space of a learning agent $l$, typically $\mathbb{O}_l \subseteq \RR^g$.
